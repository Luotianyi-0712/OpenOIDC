...
<template>
  <div class="max-w-6xl">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between mb-6">
      ...
      <button @click="refreshUsers" :disabled="loading" class="inline-flex items-center gap-2 px-3 py-2 border border-border rounded-lg text-sm font-medium hover:bg-muted transition-colors disabled:opacity-50">
